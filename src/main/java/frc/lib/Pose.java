...
public class Pose {
   ...
   * @param rotation The rotational component of the pose.
   */
  public Pose(double x, double y, Rotation2d rotation) {
    m_translation = new Translation2d(x, y);
    m_rotation = rotation;
  }

  public Pose(Pose2d pose2d) {
    m_translation = pose2d.getTranslation();
    m_rotation = pose2d.getRotation();
  }
   ...
   */
  public Transform2d minus(Pose other) {
  ...
  public Pose relativeTo(Pose other) {
    var transform = new Transform2d(other.toPose2d(), this.toPose2d());
  ...
  public boolean equals(Object obj) {
    if (obj instanceof Pose) {
      return ((Pose) obj).m_translation.equals(m_translation)
          && ((Pose) obj).m_rotation.equals(m_rotation);
    }
    return false;
  }
  ...
  public void incrementTranslation(Translation2d newTranslation) {
    this.m_translation = this.m_translation.plus(newTranslation);
  }
  ...
  public void incrementRotation(Rotation2d newRotation) {
    this.m_rotation = this.m_rotation.plus(newRotation);
  }
